...
namespace Kriptal.Droid.Services
{
    public class SenderService : ISender
    {
        ...
        {
            string fullPath = Path.Combine(Android.OS.Environment.ExternalStorageDirectory.AbsolutePath,
                                          fileName);
            return fullPath;
        }
        ...
        {
            var mimeType = GetMimeType(path.Split('.')[1]);

            path = Path.Combine(Android.OS.Environment.ExternalStorageDirectory.AbsolutePath, "Kriptal-" + path);
